...
if (BUILD_EIGEN)
    ...
    if (NOT EXISTS "${EIGEN_INCLUDE_DIR}/Eigen/Core")
        if (NOT FETCH_MISSING_DEPS)
            message(FATAL_ERROR "Bundled Eigen is incomplete: ${EIGEN_INCLUDE_DIR}/Eigen/Core is missing")
        endif ()
        ...
        FetchContent_GetProperties(eigen_source)
        if (NOT eigen_source_POPULATED)
            if (POLICY CMP0169)
                cmake_policy(PUSH)
                cmake_policy(SET CMP0169 OLD)
            endif ()
            FetchContent_Populate(eigen_source)
            if (POLICY CMP0169)
                cmake_policy(POP)
            endif ()
        endif ()
        set(EIGEN_INCLUDE_DIR "${eigen_source_SOURCE_DIR}")
        message(WARNING "Bundled Eigen is incomplete; using pinned Eigen 3.4.0 from ${EIGEN_INCLUDE_DIR}")
    endif ()
